...
-->
    <title>PLAN MAESTRO DE MANTENIMIENTO </title>
        ...
        <div class="container">
            ...
            <div class="tm-main-content">
                <section class="tm-margin-b-l">
                    ...
                    <p>El PMM Referencia del Articulo en un conjunto de acciones a ejecutar con cierta
periodicidad (hasta un año) para anticiparnos a la salida de servicio de equipos,
herramientas y elementos de uso corriente, o deterioro pronunciado de las instalaciones.
Para confeccionarlo se identifican todas las tareas preventivas que se pueden realizar, y
luego se les asigna una periodicidad. Por ejemplo, revisión de tubos fluorescentes y
reemplazo de los quemados. Periodicidad 3 meses. Todas las tareas se vuelcan en una
planilla segmentada por meses.
Características o Elementos del plan maestro.
1.- Los objetivos del plan general.
2.- Su descripción.
3.- Nombre de los planes particulares o específicos que lo integran.
4.- Tiempo y limite que tiene o abarca el plan maestro.
5.- Tiempo y límite de los planes en su conjunto o particularmente.
6.- Necesidad del plan maestro.
7.- Necesidades de los planes específicos.
8.- Implementación del plan en su conjunto o particularmente.</p>
